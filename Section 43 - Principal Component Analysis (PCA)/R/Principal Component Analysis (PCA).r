...
points(grid_set, pch = '.', col = ifelse(y_grid == 2, "deepskyblue", ifelse(y_grid == 1, "springgreen3", "tomato"))) # nolint
points(set, pch = 21, bg = ifelse(set[, 3] == 2, "blue3", ifelse(set[, 3] == 1, "green4", "red3"))) # nolint
